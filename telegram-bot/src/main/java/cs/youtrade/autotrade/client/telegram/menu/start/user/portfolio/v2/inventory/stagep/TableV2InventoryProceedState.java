package cs.youtrade.autotrade.client.telegram.menu.start.user.portfolio.v2.inventory.stagep;
...
@Service
public class TableV2InventoryProceedState extends YTPTerminalTextMenuState {
    private final SellV2InventoryEndpoint endpoint;
    private final TableV2InventoryRegistry registry;

    public TableV2InventoryProceedState(
    ...
    public String getHeaderText(TelegramClient bot, UserData userData) {
        ...
        return String.format("""
                        %s <b>Предметы из инвентаря приняты в обработку</b>
