...
public enum TdpField implements FcdDistance {
    ...
    MIN_CUTOFF(
            DirType.BUY,
            "Коэффициент для определения минимальной скидки баргейна",
            "Допустимое значение коэффициента: от 1% до 100%"
    ),
    MAX_CUTOFF(
            DirType.BUY,
            "Коэффициент для определения максимальной скидки баргейна",
            "Допустимое значение коэффициента: от 1% до 100%"
    ),
    BARGAIN_AWAIT(
            DirType.BUY,
            "Количество часов, которое мы можем ждать перед снятием баргейна",
            "Допустимое значения количества часов: от 1 до 24"
    ),
    MIN_AUTOSELL_PROFIT(
            DirType.SELL,
