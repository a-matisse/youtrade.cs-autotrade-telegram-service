package cs.youtrade.autotrade.client.telegram.menu.start.user.params.autobuy.words.deleteall.stagep;
...
@Service
public class WordsDeleteAllProceedState extends YTPTerminalTextMenuState {
