package cs.youtrade.autotrade.client.telegram.menu.start.user.params.pswitch.stage1;

import cs.youtrade.autotrade.client.telegram.menu.UserMenu;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.pswitch.ParamsSwitchData;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.pswitch.ParamsSwitchRegistry;
...
public class ParamsSwitchIdState extends AbstractTextState {
    ...
    public UserMenu supportedState() {
        return UserMenu.PARAMS_SWITCH_STAGE_1;
    }
    ...
    public UserMenu execute(TelegramClient bot, Update update, UserData user) {
        ...
        data.setInput(input);
        return UserMenu.PARAMS_SWITCH_STAGE_P;
    }
