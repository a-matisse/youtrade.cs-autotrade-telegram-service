package cs.youtrade.autotrade.client.telegram.menu.start.user.params.portfolio.upload.stage1;

import cs.youtrade.autotrade.client.telegram.menu.UserMenu;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.portfolio.AbstractTableState;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.portfolio.upload.TableUploadData;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.portfolio.upload.TableUploadRegistry;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.portfolio.upload.stage1.generator.TableUploadGenerator;
