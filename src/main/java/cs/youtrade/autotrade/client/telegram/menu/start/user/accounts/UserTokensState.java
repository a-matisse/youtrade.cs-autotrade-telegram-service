...
public class UserTokensState extends YTPTextMenuState<UserTokensMenu> {
    ...
    public UserMenu executeCallback(TelegramClient bot, Update update, UserData userData, UserTokensMenu t) {
        return switch (t) {
            case TOKEN_ADD -> UserMenu.ACCOUNTS_ADD_STAGE_CHOOSE;
            case TOKEN_REMOVE -> UserMenu.ACCOUNTS_REMOVE_STAGE_CHOOSE;
            case TOKEN_RENAME -> UserMenu.ACCOUNTS_RENAME_STAGE_1;
