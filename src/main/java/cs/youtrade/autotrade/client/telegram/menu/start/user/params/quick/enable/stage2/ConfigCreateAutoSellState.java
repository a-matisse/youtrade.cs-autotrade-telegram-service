package cs.youtrade.autotrade.client.telegram.menu.start.user.params.quick.enable.stage2;
...
@Service
public class ConfigCreateAutoSellState extends AbstractQuickConfigGradeState {
    private final QuickConfigCreateRegistry registry;

    public ConfigCreateAutoSellState(
    ...
    public String getHeaderText(TelegramClient bot, UserData userData) {
        return """
                🎚 <b>Строгость продажи</b>
                ━━━━━━━━━━━━━━━━━━━━━
                
                Выберите уровень фильтрации продаж.
                <b>Более строгий</b> режим <b>снижает частоту</b> сделок,
                но <b>повышает потенциальную прибыль</b> с каждой продажи.
                """;
    }
}
