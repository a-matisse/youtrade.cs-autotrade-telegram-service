package cs.youtrade.autotrade.client.telegram.menu.start.user.params.portfolio.upload.stage1.generator;

import cs.youtrade.autotrade.client.telegram.menu.start.user.params.portfolio.ITableGenerator;
        ...
        try (Workbook wb = new XSSFWorkbook(new FileInputStream(file))) {
            ...
            for (int i = 0; i < wb.getNumberOfSheets(); i++) {
                ...
                for (Row row : sheet) {
                    ...
                    String boughtStr = getCellString(row.getCell(2));
