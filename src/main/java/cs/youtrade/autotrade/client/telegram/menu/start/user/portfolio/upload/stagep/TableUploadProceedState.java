package cs.youtrade.autotrade.client.telegram.menu.start.user.portfolio.upload.stagep;
...
@Service
public class TableUploadProceedState extends YTPTerminalTextMenuState {
