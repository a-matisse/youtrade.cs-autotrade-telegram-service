package cs.youtrade.autotrade.client.telegram.menu.start.user.accounts.add.stages.seller.stage1;
...
@Service
public class SellerAddApiState extends AbstractAddApiState {
    public SellerAddApiState(
    ...
    public UserMenu supportedState() {
        return UserMenu.ACCOUNTS_ADD_STAGE_1_SELLER;
    }
