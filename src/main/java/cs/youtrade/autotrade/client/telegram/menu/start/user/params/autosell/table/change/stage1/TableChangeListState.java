package cs.youtrade.autotrade.client.telegram.menu.start.user.params.autosell.table.change.stage1;

import cs.youtrade.autotrade.client.telegram.menu.UserMenu;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.autosell.table.AbstractTableState;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.autosell.table.change.TableChangeData;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.autosell.table.change.TableChangeRegistry;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.autosell.table.change.stage1.generator.TableChangeGroupGenerator;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.autosell.table.change.stage1.generator.TableChangeSingleGenerator;
