package cs.youtrade.autotrade.client.telegram.menu.start.user.params.portfolio.history.stagep;

import cs.youtrade.autotrade.client.telegram.menu.UserMenu;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.portfolio.history.TableHistoryRegistry;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.portfolio.history.stagep.generator.TableHistoryGenerator;
