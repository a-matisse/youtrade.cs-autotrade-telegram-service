package cs.youtrade.autotrade.client.telegram.menu.start.user.params.deep.rename.stage1;

import cs.youtrade.autotrade.client.telegram.menu.UserMenu;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.deep.rename.UserRenameData;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.deep.rename.UserParamsRenameRegistry;
...
public class ParamsRenameIdState extends AbstractTextState {
    ...
    public UserMenu supportedState() {
        return UserMenu.DEEP_PARAMS_RENAME_STAGE_1;
    }
    ...
    public UserMenu execute(TelegramClient bot, Update update, UserData user) {
        ...
        data.setId(paramsId);
        return UserMenu.DEEP_PARAMS_RENAME_STAGE_2;
    }
