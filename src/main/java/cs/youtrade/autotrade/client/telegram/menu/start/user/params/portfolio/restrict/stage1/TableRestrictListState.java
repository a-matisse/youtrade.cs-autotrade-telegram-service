package cs.youtrade.autotrade.client.telegram.menu.start.user.params.portfolio.restrict.stage1;

import cs.youtrade.autotrade.client.telegram.menu.UserMenu;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.portfolio.AbstractTableState;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.portfolio.restrict.TableRestrictData;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.portfolio.restrict.TableRestrictRegistry;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.portfolio.restrict.stage1.generator.TableRestrictGenerator;
