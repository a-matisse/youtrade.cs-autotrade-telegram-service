package cs.youtrade.autotrade.client.telegram.menu.start.user.params.table.change.choose;
...
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.table.change.TableChangeType;
