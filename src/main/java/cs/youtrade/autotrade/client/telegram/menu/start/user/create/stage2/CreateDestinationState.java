package cs.youtrade.autotrade.client.telegram.menu.start.user.create.stage2;

import cs.youtrade.autotrade.client.telegram.menu.UserMenu;
import cs.youtrade.autotrade.client.telegram.menu.start.user.create.ParamsCreateData;
import cs.youtrade.autotrade.client.telegram.menu.start.user.create.ParamsCreateRegistry;
import cs.youtrade.autotrade.client.telegram.menu.start.user.create.prototype.AbstractCreateState;
...
public class CreateDestinationState extends AbstractCreateState {
    ...
    protected String getMessage(UserData user) {
        return String.format("""
                Пожалуйста, укажите путь продажи:
