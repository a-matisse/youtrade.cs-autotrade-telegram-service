package cs.youtrade.autotrade.client.telegram.menu.start.user.params.deep.autobuy.scoring.remove.stage1;

import cs.youtrade.autotrade.client.telegram.menu.UserMenu;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.deep.autobuy.scoring.remove.ScoringRemoveData;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.deep.autobuy.scoring.remove.ScoringRemoveRegistry;
