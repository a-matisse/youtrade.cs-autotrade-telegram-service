package cs.youtrade.autotrade.client.telegram.menu.start.user.params.table.restrict.stage1;

import cs.youtrade.autotrade.client.telegram.menu.UserMenu;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.table.AbstractTableState;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.table.restrict.TableRestrictData;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.table.restrict.TableRestrictRegistry;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.table.restrict.stage1.generator.TableRestrictGenerator;
