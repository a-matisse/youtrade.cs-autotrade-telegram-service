package cs.youtrade.autotrade.client.telegram.menu.start.user.params.deep.autobuy.items.stage1;

import cs.youtrade.autotrade.client.telegram.menu.UserMenu;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.deep.autobuy.items.GetNewestItemsData;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.deep.autobuy.items.GetNewestItemsRegistry;
