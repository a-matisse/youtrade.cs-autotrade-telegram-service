package cs.youtrade.autotrade.client.telegram.menu.start.user.params.autosell.table.upload.stage1;

import cs.youtrade.autotrade.client.telegram.menu.UserMenu;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.autosell.table.AbstractTableState;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.autosell.table.upload.TableUploadData;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.autosell.table.upload.TableUploadRegistry;
import cs.youtrade.autotrade.client.telegram.menu.start.user.params.autosell.table.upload.stage1.generator.TableUploadGenerator;
...
public class TableUploadListState extends AbstractTableState<List<FcdSellUploadGetDto>> {
    ...
    public UserMenu supportedState() {
        return UserMenu.TABLE_UPLOAD_STAGE_1;
    }
    ...
    public UserMenu execute(TelegramClient bot, Update update, UserData user) {
        ...
        try {
            ...
            data.setDtos(toPost);
            return UserMenu.TABLE_UPLOAD_STAGE_P;
        } catch (Exception e) {
